...
# 目录
+ [公开数据接口](#请求应答)
   + [1. 获取交易对行情数据](#获取交易对行情数据), [\[错误码\]](#错误应答错误码)
   + [2. 获取交易对深度数据](#获取指定交易对深度), [\[错误码\]](#错误应答错误码-1)
   + [3. 获取交易对历史成交数据](#获取指定交易对历史成交数据), [\[错误码\]](#错误应答错误码-2)
+ [用户数据接口](#我的账户余额)
   + [4. 我的账户余额](#我的账户余额), [\[错误码\]](#错误应答错误码-3)
   + [5. 挂单](#挂单), [\[错误码\]](#错误应答错误码-4)
   + [6. 撤单](#撤单), [\[错误码\]](#错误应答错误码-5)
   + [7. 我的挂单](#我的挂单), [\[错误码\]](#错误应答错误码-6)
   + [8. 我的成交记录](#我的成交记录), [\[错误码\]](#错误应答错误码-7)
   + [9. 通过Tag查询我的挂单](#通过tag查询我的挂单), [\[错误码\]](#错误应答错误码-8)
   + [10. 通过Tag查询我的成交记录](#通过tag查询我的成交记录), [\[错误码\]](#错误应答错误码-9)
